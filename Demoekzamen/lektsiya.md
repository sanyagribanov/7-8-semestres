...
Добавить NUnit Тесты и выполнить<br>
![image](https://user-images.githubusercontent.com/86486142/212837525-b7ea5676-9627-4d16-adfe-24965e35457c.png)
1. Объявление ожидаемой переменной (какой результат ждем) с типом данных метода (тип данных = значение)
```C#
double expected = 0;
```
2. Объявление фактической переменной (результат по факту) с типом данных метода (тип данных = вызов функции библиотеки)
(Название библиотеки.Название класса.Назваение метода)
```C#
double actual = ClassLibraryStudent.StudentMark.MinAVG(marks);
```
3. Добавление аргументов перед функцией и тип данных из скобок убираем
```C#
string[] marks = new string[] { };
```
4. Запись переменных в AreEqual и выполнение тестов
```C#
